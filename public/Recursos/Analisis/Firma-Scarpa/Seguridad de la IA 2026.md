...
* La confianza en la **“certificación ex ante” como salvaguarda principal es problemática**; se necesita complementar con fuertes obligaciones ex post (responsabilidad, seguros, auditorías continuas, publicación de incidentes).

* Debe explorarse el uso de **“safety cases”**: dosieres argumentales estructurados que combinan evidencia técnica, análisis de amenazas, mitigaciones y planes de contingencia, más parecidos a los empleados en nuclear o aviación que a un simple sello de conformidad tipo CE.

## **IV. Marcos de Seguridad de IA de Frontera y compromisos condicionales (“if-then”)**

El Informe dedica una parte sustancial del capítulo 3 a **las prácticas de gestión de riesgos y los Marcos de Seguridad de IA de Frontera**, adoptados voluntariamente por varios desarrolladores punteros tras la Cumbre de Seúl.

## **1\. Estructura común de los marcos**

Aunque con diferencias, los marcos de empresas como Anthropic, OpenAI, Google, Meta, Amazon, Microsoft, NVIDIA o xAI presentan patrones comunes:

* Definen **dominios de riesgo** (CBRN, ciber-ofensiva, autonomía avanzada, automatización de I+D de IA, manipulación a gran escala, etc.).

* Establecen **niveles de riesgo o “AI Safety Levels”** o “Critical Capability Levels” (p.ej., ASL-1 a ASL-3, niveles bajo/medio/alto/crítico).

* Asociado a cada nivel, formulan **compromisos condicionales (“if-then commitments”)**: si las evaluaciones superan cierto umbral, entonces se activan salvaguardas específicas (limitación de acceso, incremento de seguridad interna, bloqueo de despliegue, etc.).

Ejemplos jurídicamente relevantes:

* OpenAI clasifica modelos como de **“alta capacidad”** si pueden amplificar vías existentes de daño grave (por ejemplo, bioterrorismo) y de **“capacidad crítica”** si abren vías de daño sin precedentes; para estos últimos, comprometen detener avances hasta implementar salvaguardas y seguridad equivalentes a normas internas.

* Anthropic define **niveles ASL-2 y ASL-3**; ASL-3 requiere estándares reforzados de despliegue y seguridad, e incluye por primera vez modelos donde la empresa no puede excluir la posibilidad de alcanzar ciertos umbrales peligrosos, activando medidas precautorias.
