        ...
        <section className="py-12 border-t border-divider">
          <div className="container-narrow">
            <div className="prose-editorial space-y-12">
              <div>
                <h2 className="font-serif text-2xl text-foreground mb-4">1. Qué son las cookies</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-2xl text-foreground mb-4">2. Cookies utilizadas en este sitio web</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-2xl text-foreground mb-4">3. Cookies que no se utilizan</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-2xl text-foreground mb-4">4. Gestión de cookies por el usuario</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-2xl text-foreground mb-4">5. Actualización de esta política</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-2xl text-foreground mb-4">6. Más información</h2>
                <p>
