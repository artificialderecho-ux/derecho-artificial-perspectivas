    ...
    <main className="section-spacing">
      <div className="container-editorial">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          ...
          >
            <p className="text-xs uppercase tracking-widest text-caption mb-3">Landmark ruling</p>
            <h2 className="font-serif text-2xl text-foreground mb-4">
              BOSCO Judgment: Algorithmic Transparency and Source Code
            </h2>
            <p className="text-body mb-6">
              Legal analysis of STS 1119/2025 establishing access to source code when automated decisions affect social
              benefits.
            </p>
          ...
          <div className="card-elevated p-6">
            <p className="text-xs uppercase tracking-widest text-caption mb-3">Reading criteria</p>
        ...
        <section className="mt-12 rounded-lg border border-divider bg-surface p-8">
          <p className="text-xs uppercase tracking-widest text-caption mb-3">Monitoring</p>
