      ...
      <div className="container-editorial">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <div className="card-elevated p-6">
            <p className="text-xs uppercase tracking-widest text-caption mb-3">European framework</p>
          ...
          <div className="card-elevated p-6">
            <p className="text-xs uppercase tracking-widest text-caption mb-3">Data protection</p>
          ...
          <div className="card-elevated p-6">
            <p className="text-xs uppercase tracking-widest text-caption mb-3">Transparency</p>
          ...
          <div className="card-elevated p-6">
            <p className="text-xs uppercase tracking-widest text-caption mb-3">Liability</p>
        ...
        <section className="mt-12 rounded-lg border border-divider bg-surface p-8">
          <p className="text-xs uppercase tracking-widest text-caption mb-3">2026 structure</p>
