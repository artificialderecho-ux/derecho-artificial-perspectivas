      ...
      <div className="container-editorial">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          {sortedEntries.map((entry) => (
            ...
            >
              <p className="text-xs uppercase tracking-widest text-caption mb-3">Essay</p>
        ...
        <section className="mt-12 rounded-lg border border-divider bg-surface p-8">
          <p className="text-xs uppercase tracking-widest text-caption mb-3">Editorial focus</p>
