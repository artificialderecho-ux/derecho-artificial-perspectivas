...
export const metadata: Metadata = {
  title: "IA Global",
  description:
    "Casos y desarrollos internacionales sobre regulación, justicia y gobernanza de la inteligencia artificial.",
...
export default async function IAGlobalPage() {
        ...
        <div className="space-y-8">
          <div className="container mx-auto px-4 py-8">
            <p className="text-body">
              Perspectiva comparada sobre justicia inteligente, discriminación algorítmica y marcos
              globales de regulación de la IA.
            </p>
          </div>
          {items.length === 0 ? (
