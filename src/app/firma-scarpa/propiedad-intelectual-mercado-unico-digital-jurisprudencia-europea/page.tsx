...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/firma-scarpa/propiedad-intelectual-mercado-unico-digital-jurisprudencia-europea",
  },
};

export default async function PostPage() {
  const posts = getAllPosts();
  const post = posts.find(p => p.slug === "propiedad-intelectual-mercado-unico-digital-jurisprudencia-europea");
      ...
      >
        ...
        <div className="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/fuentes/propiedad-intelectual-mercado-unico-digital.pdf"
              target="_blank"
