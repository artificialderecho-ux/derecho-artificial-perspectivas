      ...
      <article className="section-spacing" id="mision">
        <div className="container-editorial">
          ...
          <div className="prose-editorial mb-24">
            ...
            <section className="mb-16">
              ...
              <ul className="list-disc pl-6 space-y-3 my-6">
                ...
                <li>Análisis técnicos inaccesibles para no especialistas.</li>
                <li>
          ...
          <section className="mb-24 p-8 bg-surface border border-divider rounded-lg">
            <h2 className="font-serif text-2xl md:text-3xl text-foreground mb-6">Sobre el responsable editorial</h2>
          ...
          <div id="manifiesto" className="bg-surface/50 p-8 md:p-12 rounded-lg border border-border my-20">
            <header className="mb-12 text-center">
              <p className="text-sm uppercase tracking-widest text-primary mb-4 font-bold">Nuestros Principios</p>
              <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-6">Manifiesto Editorial</h2>
