...
export const metadata: Metadata = {
  title:
    "Guía del Reglamento de IA en 2026: Cumplimiento para Empresas | Derecho Artificial",
  description:
      ...
      >
        ...
        <div className="mb-12 p-8 bg-slate-50 border border-slate-200 rounded-sm not-prose">
          ...
          <p className="text-slate-700 mb-6 leading-relaxed text-justify hyphens-auto">
            El Reglamento Europeo de Inteligencia Artificial (EU AI Act) establece el primer marco jurídico integral del mundo para la IA. Esta guía desglosa las obligaciones clave para proveedores y usuarios, el sistema de clasificación de riesgos y los plazos de implementación escalonada que culminan en 2026. Documento esencial para departamentos legales y de compliance.
          </p>
          <a 
        ...
        <p className="lead">
          ...
          <strong>cumplimiento legal</strong> ya no es una opción, sino un
          requisito de mercado fundamental para operar en la Unión Europea.
        </p>
        ...
        <p>
          Aquellos utilizados en infraestructuras críticas, educación, empleo o
          servicios públicos esenciales. Estos sistemas requieren una evaluación
          de conformidad rigurosa, gestión de calidad y supervisión humana para
          mitigar posibles <strong>sesgos algorítmicos</strong> que puedan
        ...
        <p>
          ...
          <strong>derechos fundamentales</strong>, como el scoring social por
          parte de gobiernos o la manipulación subliminal del comportamiento
          humano.
        </p>
        ...
        <p>
          ...
          asume el rol de autoridad de vigilancia de mercado. Las sanciones por
          incumplimiento pueden alcanzar hasta el 7% del volumen de negocio
          global anual o 35 millones de euros, lo que subraya la importancia
          crítica de una adaptación temprana.
        </p>
        ...
        <div className="my-10 p-6 bg-blue-50/50 border border-blue-100 rounded-sm not-prose">
          ...
          <Link href="/jurisprudencia/sentencia-bosco-transparencia-algoritmica" className="text-blue-700 font-medium hover:underline flex items-center gap-2 text-sm">
        ...
        <div className="mt-12 mb-16 not-prose">
          ...
          <div className="space-y-4">
            ...
            <details className="group border border-border rounded-sm p-4 bg-card">
              ...
              <p className="group-open:animate-fadeIn mt-3 text-muted-foreground text-sm leading-relaxed text-justify">
                El Reglamento entra en vigor 20 días después de su publicación, pero su aplicabilidad es escalonada. Las prohibiciones de riesgo inaceptable aplican a los 6 meses, y la mayoría de las normas a los 24 meses (2026).
              </p>
            </details>
          </div>
        </div>
