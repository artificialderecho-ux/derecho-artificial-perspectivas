      ...
      <section className="py-12 border-t border-divider">
        <div className="container-narrow">
          <div className="prose-editorial space-y-12">
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">1. Identificación del responsable</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">2. Condiciones de uso</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">3. Propiedad intelectual</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">4. Exclusión de responsabilidad</h2>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">5. Legislación aplicable y jurisdicción</h2>
