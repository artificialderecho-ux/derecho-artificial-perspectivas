...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/jurisprudencia/sentencia-lgberlin-voice-cloning-ia-2025",
  },
};

export default async function PostPage() {
  const posts = getAllPosts();
  const post = posts.find(p => p.slug === "sentencia-lgberlin-voice-cloning-ia-2025");
      ...
      >
        ...
        <div className="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/fuentes/jurisprudencia-ia-voice-cloning-lgberlin.pdf"
              target="_blank"
