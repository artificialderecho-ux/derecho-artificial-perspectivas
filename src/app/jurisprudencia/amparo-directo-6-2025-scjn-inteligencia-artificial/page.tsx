...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/jurisprudencia/amparo-directo-6-2025-scjn-inteligencia-artificial",
  },
};

export default async function PostPage() {
  const posts = getAllPosts();
  const post = posts.find(p => p.slug === "amparo-directo-6-2025-scjn-inteligencia-artificial");
      ...
      >
        ...
        <div className="mb-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/fuentes/amparo-directo-6-2025-scjn-jurisprudencia.pdf"
              target="_blank"
