      ...
      <section className="py-12 border-t border-divider">
        <div className="container-narrow">
          <div className="prose-editorial space-y-12">
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">1. Responsable del tratamiento</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">2. Datos personales tratados</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">3. Finalidad del tratamiento</h2>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">4. Base jurídica del tratamiento</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">5. Conservación de los datos</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">6. Cesión y transferencias internacionales de datos</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">7. Derechos del interesado</h2>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">8. Medidas de seguridad</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl text-foreground mb-4">9. Modificaciones de la política de privacidad</h2>
              <p>
