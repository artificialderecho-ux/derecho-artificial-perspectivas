          ...
          <div className="space-y-6">
            <div className="bg-surface p-8 md:p-10 border border-divider">
              ...
              <p className="text-body leading-relaxed mb-6">
                Deep dive into Regulation (EU) 2024/1689. Risk architecture, GPAI obligations, 
                and governance implications for providers, deployers, and public institutions.
              </p>
              <Link 
                to="/en/analysis/strategic-report-ai-act" 
