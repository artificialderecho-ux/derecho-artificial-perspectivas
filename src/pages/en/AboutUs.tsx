...
const AboutUs = () => {
  return (
    <Layout>
      <SEOHead 
        title="Who We Are | Derecho Artificial"
        description="We are an independent observatory analyzing the impact of AI on Law. Our mission, team, and Editorial Manifesto."
        canonical="https://derechoartificial.com/en/about-us"
        hreflangs={[
      ...
      <section className="py-24 bg-surface">
        <div className="container-narrow">
          ...
          <div className="prose prose-lg text-body">
            <p>
              Derecho Artificial is an independent initiative born from the intersection between legal technique and technological reality. We do not just inform; we analyze, deconstruct, and project the future of regulation in the era of algorithms.
            </p>
            <p>
              Our mission is clear: to provide rigour in a noise-filled environment. We connect the EU AI Act with the daily reality of firms, translate technical papers into legal risks, and oversee the actions of new regulatory bodies like AESIA.
            </p>
          </div>
        </div>
      </section>

      {/* MANIFESTO SECTION - Highlighted as requested */}
        ...
        <div className="grid gap-12">
          <article className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-body">We do not confuse 'automation' with 'intelligence'. We distinguish between Machine Learning and Symbolic Logic. Legal analysis requires technical precision.</p>
            </div>
          </article>
          ...
          <article className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-body">We are not spokespersons for any Big Tech or lobby. We analyze regulation from the perspective of rights and legal security, not commercial hype.</p>
            </div>
          </article>
          ...
          <article className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-body">Technology must serve the human being, not the other way around. We defend the supremacy of fundamental rights in the face of algorithmic efficiency.</p>
            </div>
          </article>
          ...
          <article className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-body">We don't wait for the law to be published. We analyze drafts, proposals, and trends to anticipate the regulatory future.</p>
            </div>
          </article>
          ...
          <article className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-body">Law cannot be understood in isolation. We integrate Philosophy, Ethics, and Computer Science into our legal analysis.</p>
            </div>
          </article>
          ...
          <article className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-body">In the age of post-truth and generative AI, we verify sources, cross-check data, and rectify errors transparently.</p>
            </div>
          </article>
        </div>
      </div>
