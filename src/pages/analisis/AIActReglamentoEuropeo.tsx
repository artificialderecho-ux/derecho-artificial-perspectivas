...
const AIActReglamentoEuropeo = () => {
  return (
    <Layout>
      <SEOHead 
        title="Reglamento Europeo de Inteligencia Artificial (AI Act): Análisis Jurídico"
        description="Análisis jurídico integral del AI Act: arquitectura normativa, enfoque basado en riesgos y obligaciones para el sector legal."
        canonical="https://derechoartificial.com/analisis/ai-act-reglamento-europeo"
        type="article"
        ...
        <div className="container-narrow">
          ...
          <header className="mb-16">
            <div className="flex items-center gap-4 mb-6">
              ...
              <time className="text-sm text-caption">31 de diciembre, 2024</time>
            </div>
          ...
          <div className="prose-editorial">
            ...
            <section className="mb-16">
              ...
              <p>
                Para las administraciones públicas, el impacto es especialmente intenso. El uso de sistemas de IA en la tramitación de expedientes, en la evaluación de solicitudes o en la asistencia a decisiones administrativas quedará sujeto a las obligaciones de alto riesgo. Esto implicará la necesidad de auditar los sistemas existentes, adaptar los procedimientos de contratación pública y establecer protocolos de supervisión humana efectiva.
              </p>
              <p>
            ...
            {/* Back link */}
            <footer className="pt-8 border-t border-divider">
              <Link 
                to="/analisis" 
...
export default AIActReglamentoEuropeo;
