...
export default function GlosarioIALegal() {
  ...
  return (
    <Layout>
      ...
      {/* Schema específico para el Glosario */}
          ...
          <div className="max-w-3xl mx-auto">
            {filteredTerms.length > 0 ? (
              ...
              <div className="text-center py-20">
                <p className="text-[#64748B] text-lg">No se encontraron resultados para "{searchTerm}"</p>
                <button 
