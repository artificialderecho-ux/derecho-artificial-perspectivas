...
author: "Redacción"
slug: "angela-lipps-reconocimiento-facial-causa-probable"
readingTime: "7 min"
...
export const metadata = {
  ...
  openGraph: {
    title: "Angela Lipps, 50 años: 6 meses en prisión por un algoritmo que la buscaba a 1.200 millas de distancia",
    description: "Un análisis crítico de cómo el reconocimiento facial erosiona la causa probable y desmorona las garantías de la Cuarta Enmienda en investigaciones criminales.",
    url: "/jurisprudencia/angela-lipps-reconocimiento-facial-cuarta-enmienda",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Angela Lipps, 50 años: 6 meses en prisión por un algoritmo que la buscaba a 1.200 millas de distancia",
      }
    ],
  },
  twitter: {
