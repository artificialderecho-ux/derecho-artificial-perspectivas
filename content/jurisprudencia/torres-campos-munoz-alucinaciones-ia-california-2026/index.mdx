...
export const metadata = {
  ...
  openGraph: {
    title: "Alucinaciones de IA y responsabilidad del abogado: la sentencia Torres Campos v. Munoz del Tribunal de Apelación de California",
    description: "Análisis de la sentencia D085584 (Cal. App. 4th Dist., 5 marzo 2026): primer pronunciamiento californiano que sanciona con 5.000 dólares a una abogada por citar jurisprudencia ficticia generada por IA y no verificarla.",
    url: "/jurisprudencia/torres-campos-munoz-alucinaciones-ia-california-2026",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Alucinaciones de IA y responsabilidad del abogado: la sentencia Torres Campos v. Munoz del Tribunal de Apelación de California",
      }
    ],
  },
  twitter: {
