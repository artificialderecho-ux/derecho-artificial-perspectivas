...
export const metadata = {
  ...
  openGraph: {
    title: "El Tribunal de Internet de Pekín reconoce el copyright de imágenes generadas con IA: análisis de la sentencia Li v. Liu (2023)",
    description: "El Tribunal de Internet de Pekín reconoce por primera vez el copyright de una imagen generada con Stable Diffusion. Análisis de la sentencia (2023) Jing 0491 Min Chu No. 11279.",
    url: "/jurisprudencia/tribunal-internet-pekin-copyright-imagen-ia-generativa-stable-diffusion",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "El Tribunal de Internet de Pekín reconoce el copyright de imágenes generadas con IA: análisis de la sentencia Li v. Liu (2023)",
      }
    ],
  },
  twitter: {
