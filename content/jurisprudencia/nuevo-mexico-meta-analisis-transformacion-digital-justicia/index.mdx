...
export const metadata = {
  ...
  openGraph: {
    title: "Algoritmos en el Banquillo: El Caso State of New Mexico v. Meta Platforms Inc. y la Reconstrucción de la Responsabilidad Civil en la Era Digital",
    description: "Análisis completo del caso histórico contra Meta Platforms, la operación MetaPhile, y el cambio de paradigma en la responsabilidad de las plataformas digitales.",
    url: "/jurisprudencia/nuevo-mexico-meta-analisis-transformacion-digital-justicia",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Algoritmos en el Banquillo: El Caso State of New Mexico v. Meta Platforms Inc. y la Reconstrucción de la Responsabilidad Civil en la Era Digital",
      }
    ],
  },
  twitter: {
    ...
    title: "Algoritmos en el Banquillo: El Caso State of New Mexico v. Meta Platforms Inc. y la Reconstrucción de la Responsabilidad Civil en la Era Digital",
    description: "Análisis completo del caso histórico contra Meta Platforms, la operación MetaPhile, y el cambio de paradigma en la responsabilidad de las plataformas digitales.",
    images: ["/images/heroes/posts_images/jurisprudencia-ia-hero.jpg"],
  },
};;
