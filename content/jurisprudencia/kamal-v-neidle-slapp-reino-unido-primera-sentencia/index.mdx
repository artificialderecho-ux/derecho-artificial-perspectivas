...
export const metadata = {
  ...
  openGraph: {
    title: "Kamal v. Neidle: la primera sentencia sobre SLAPP en el Reino Unido y su impacto en la libertad de expresión frente a litigation finance",
    description: "Análisis de la sentencia del High Court que aplica por primera vez la Sección 195 de la Economic Crime Act 2023, declarando SLAPP una demanda por libelo contra un periodista fiscal.",
    url: "/jurisprudencia/kamal-v-neidle-slapp-reino-unido-primera-sentencia",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Kamal v. Neidle: la primera sentencia sobre SLAPP en el Reino Unido y su impacto en la libertad de expresión frente a litigation finance",
      }
    ],
  },
  twitter: {
