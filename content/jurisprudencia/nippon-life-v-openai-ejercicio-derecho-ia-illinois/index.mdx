...
export const metadata = {
  ...
  openGraph: {
    title: "Nippon Life v. OpenAI: ¿Puede una IA ser demandada por ejercicio ilícito del derecho?",
    description: "Análisis jurídico de la demanda Nippon Life v. OpenAI (N.D. Ill. 2026): interferencia contractual, abuso procesal y ejercicio no autorizado del derecho por ChatGPT bajo la ley de Illinois.",
    url: "/jurisprudencia/nippon-life-v-openai-ejercicio-derecho-ia-illinois",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Nippon Life v. OpenAI: ¿Puede una IA ser demandada por ejercicio ilícito del derecho?",
      }
    ],
  },
  twitter: {
