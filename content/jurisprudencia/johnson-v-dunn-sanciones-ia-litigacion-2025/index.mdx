...
export const metadata = {
  ...
  openGraph: {
    title: "Johnson v. Dunn: Inhabilitación de abogados por citas alucinadas de ChatGPT en litigación federal",
    description: "Análisis de la orden de sanciones del N.D. Alabama (julio 2025): inhabilitación, reprensión pública y remisión al Colegio de Abogados por citas fabricadas con IA generativa.",
    url: "/jurisprudencia/johnson-v-dunn-sanciones-ia-litigacion-2025",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Johnson v. Dunn: Inhabilitación de abogados por citas alucinadas de ChatGPT en litigación federal",
      }
    ],
  },
  twitter: {
