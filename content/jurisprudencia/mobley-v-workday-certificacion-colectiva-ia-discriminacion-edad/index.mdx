...
export const metadata = {
  ...
  openGraph: {
    title: "Mobley v. Workday: certificación colectiva por discriminación algorítmica en el acceso al empleo",
    description: "El tribunal federal de California certifica una acción colectiva por discriminación de edad contra el sistema de IA de Workday. Análisis del impacto en la regulación de la IA en el empleo.",
    url: "/jurisprudencia/mobley-v-workday-certificacion-colectiva-ia-discriminacion-edad",
    images: [
      {
        url: "/images/heroes/posts_images/jurisprudencia-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Mobley v. Workday: certificación colectiva por discriminación algorítmica en el acceso al empleo",
      }
    ],
  },
  twitter: {
