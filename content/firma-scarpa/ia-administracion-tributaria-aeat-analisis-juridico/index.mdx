...
export const metadata = {
  ...
  openGraph: {
    title: "IA en la AEAT: análisis jurídico del despliegue de sistemas automáticos en la Agencia Tributaria",
    description: "HERMES selecciona contribuyentes sin que puedan conocer los criterios. Analizamos si el marco legal vigente —LGT, RIA y RGPD— lo permite o lo prohíbe.",
    url: "/firma-scarpa/ia-administracion-tributaria-aeat-analisis-juridico",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "IA en la AEAT: análisis jurídico del despliegue de sistemas automáticos en la Agencia Tributaria",
      }
    ],
  },
  twitter: {
