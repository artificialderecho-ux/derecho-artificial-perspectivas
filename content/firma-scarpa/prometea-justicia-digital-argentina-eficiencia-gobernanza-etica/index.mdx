...
export const metadata = {
  ...
  openGraph: {
    title: "Prometea: IA en la Justicia Argentina entre la Eficiencia y la Ética",
    description: "Análisis del sistema Prometea del MPF de Buenos Aires: cómo la IA redujo los tiempos de amparo de 160 a 38 días, con un 96% de acierto y supervisión humana obligatoria.",
    url: "/firma-scarpa/prometea-justicia-digital-argentina-eficiencia-gobernanza-etica",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Prometea: IA en la Justicia Argentina entre la Eficiencia y la Ética",
      }
    ],
  },
  twitter: {
