...
export const metadata = {
  ...
  openGraph: {
    title: "Deepfakes en el proceso judicial: cuando la inteligencia artificial obliga a repensar la prueba digital",
    description: "Análisis de los desafíos procesales de los deepfakes: por qué la inmediación del juez ya no basta y cómo la ISO 27037 y el Reglamento de IA pueden salvar la presunción de inocencia.",
    url: "/firma-scarpa/deepfakes-proceso-judicial-prueba-digital",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Deepfakes en el proceso judicial: cuando la inteligencia artificial obliga a repensar la prueba digital",
      }
    ],
  },
  twitter: {
