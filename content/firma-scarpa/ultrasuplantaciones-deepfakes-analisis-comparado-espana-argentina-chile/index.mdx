...
export const metadata = {
  ...
  openGraph: {
    title: "Ultrasuplantaciones y derechos de la personalidad: el 96% de los deepfakes son pornografía no consentida",
    description: "Análisis comparado de las respuestas legales en España, Argentina y Chile: de la AEPD al art. 1757 del Código Civil argentino. Datos, retos y propuestas de lege ferenda.",
    url: "/firma-scarpa/ultrasuplantaciones-deepfakes-analisis-comparado-espana-argentina-chile",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Ultrasuplantaciones y derechos de la personalidad: el 96% de los deepfakes son pornografía no consentida",
      }
    ],
  },
  twitter: {
