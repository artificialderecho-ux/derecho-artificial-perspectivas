...
En el ecosistema Linux, el modelo fue capaz de encontrar de forma autónoma y encadenar diversas vulnerabilidades en el *kernel* para lograr una escalada de privilegios, permitiendo a un usuario ordinario obtener el control total del sistema (1, 15). Otros hallazgos incluyen la identificación de **271** vulnerabilidades en la versión **150** de Mozilla Firefox y un fallo crítico en la biblioteca criptográfica wolfSSL (**CVE**‑**2026**‑**5194**) que permitía la forja de certificados **SSL**/**TLS** para suplantar portales bancarios o de correo electrónico (17, 19).
