...
export const metadata = {
  ...
  openGraph: {
    title: "Anthropic v. Department of War: cuando el gobierno castiga a una empresa de IA por decir que no",
    description: "El Pentágono designó a Anthropic «riesgo para la cadena de suministro» por negarse a eliminar sus límites éticos en Claude. Análisis constitucional desde la Primera Enmienda, el debido proceso y la doctrina ultra vires.",
    url: "/firma-scarpa/anthropic-v-department-of-war-primera-enmienda-ia",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Anthropic v. Department of War: cuando el gobierno castiga a una empresa de IA por decir que no",
      }
    ],
  },
  twitter: {
