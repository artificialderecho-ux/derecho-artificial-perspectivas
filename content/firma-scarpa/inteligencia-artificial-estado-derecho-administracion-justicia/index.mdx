...
export const metadata = {
  ...
  openGraph: {
    title: "Inteligencia Artificial y el Estado de Derecho en la Administracion de Justicia",
    description: "Informe academico sobre el impacto de la IA en el poder judicial: arquitectura tecnica, aplicaciones reales, etica algorítmica, derechos humanos y modelos de gobernanza. Por Ricardo Scarpa.",
    url: "/firma-scarpa/inteligencia-artificial-estado-derecho-administracion-justicia",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Inteligencia Artificial y el Estado de Derecho en la Administracion de Justicia",
      }
    ],
  },
  twitter: {
