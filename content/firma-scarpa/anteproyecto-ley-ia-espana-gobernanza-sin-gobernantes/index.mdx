...
export const metadata = {
  ...
  openGraph: {
    title: "Anteproyecto de Ley de IA en España: gobernanza sin gobernantes y los límites estructurales de la regulación nacional",
    description: "Análisis doctrinal del anteproyecto de ley de inteligencia artificial en España: límites competenciales, gobernanza fragmentada y tensiones con el AI Act europeo.",
    url: "/firma-scarpa/anteproyecto-ley-ia-espana-gobernanza-sin-gobernantes",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Anteproyecto de Ley de IA en España: gobernanza sin gobernantes y los límites estructurales de la regulación nacional",
      }
    ],
  },
  twitter: {
