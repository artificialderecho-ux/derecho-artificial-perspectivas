...
export const metadata = {
  ...
  openGraph: {
    title: "Vigilancia vertical: la convergencia RPAS-IA y el colapso de las salvaguardas legales",
    description: "Análisis profundo de cómo los sistemas aéreos pilotados a distancia erosionan el anonimato público. Arquitectura normativa comparada (España, UK, US), protección de datos, derechos fundamentales y propuestas de lege ferenda bajo el Reglamento de IA (2024/1689).",
    url: "/firma-scarpa/vigilancia-vertical-rpas-ia-colapso-salvaguardas",
    images: [
      {
        url: "/images/heroes/posts_images/firma-scarpa-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Vigilancia vertical: la convergencia RPAS-IA y el colapso de las salvaguardas legales",
      }
    ],
  },
  twitter: {
