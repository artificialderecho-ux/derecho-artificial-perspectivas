...
Mediante un ensayo controlado aleatorizado con aproximadamente cien estudiantes de derecho de nivel superior de la Universidad de Minnesota, los investigadores analizaron cuatro tareas secuenciales: síntesis, comprensión, aplicación y revisión. Los hallazgos revelan una realidad compleja: la IA incrementó la productividad en la síntesis entre un 50% y un 70%, pero no se observó una degradación en la comprensión posterior. Sorprendentemente, los participantes expuestos a la IA superaron al grupo de control en la tarea de aplicación independiente.
