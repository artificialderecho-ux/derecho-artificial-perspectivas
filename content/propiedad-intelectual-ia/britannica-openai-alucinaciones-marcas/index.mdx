...
slug: "britannica-openai-alucinaciones-marcas-lanham"
readingTime: "9 min"
...
export const metadata = {
  ...
  openGraph: {
    title: "Britannica demanda a OpenAI por alucinaciones: la batalla por la verdad verificada",
    description: "ChatGPT genera información falsa atribuida a Britannica. Ahora los tribunales decidirán si las alucinaciones son infracción de marca registrada, no solo de copyright.",
    url: "/propiedad-intelectual-ia/britannica-openai-alucinaciones-marcas",
    images: [
      {
        url: "/images/heroes/posts_images/propiedad-intelectual-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Britannica demanda a OpenAI por alucinaciones: la batalla por la verdad verificada",
      }
    ],
  },
  twitter: {
