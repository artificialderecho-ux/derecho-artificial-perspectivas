...
export const metadata = {
  ...
  openGraph: {
    title: "Algoritmos de la Infamia: Análisis Jurídico del Fraude Masivo de Streaming Asistido por IA",
    description: "Análisis jurídico transversal del caso Michael Smith: el primer precedente penal federal estadounidense sobre fraude de streaming masivo asistido por inteligencia artificial, con implicaciones críticas para los modelos de distribución de regalías y la arquitectura de las plataformas de streaming.",
    url: "/propiedad-intelectual-ia/algoritmos-infamia-smith-fraude-streaming",
    images: [
      {
        url: "/images/heroes/posts_images/propiedad-intelectual-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "Algoritmos de la Infamia: Análisis Jurídico del Fraude Masivo de Streaming Asistido por IA",
      }
    ],
  },
  twitter: {
