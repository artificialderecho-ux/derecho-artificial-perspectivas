...
📄 **[Descargar Estudio Principal: "Sycophantic AI Decreases Prosocial Intentions and Promotes Dependence"](./sycophantic-ai-main-study.pdf)** — Cheng, M., Lee, C., Khadpe, P., Yu, S., Han, D., & Jurafsky, D. (Stanford). Science 391, eaec8352 (2026).

📄 **[Descargar Materiales Suplementarios y Análisis Completo](./sycophantic-ai-supplementary.pdf)** — Incluye metodología detallada, tablas de datos, análisis ordinal, ejemplos de conversación y resultados de robustez.
