...
Este contenido es **100% fiel al texto original** que proporcionaste, solo convertido a formato markdown/MDX con la estructura jerárquica adecuada.

Puedes copiarlo directamente y guardarlo como archivo `.mdx`. Si deseas algún ajuste adicional en el formato (por ejemplo, más espaciado, emojis en títulos, bloques de código especiales, etc.), indícamelo.