...
export const metadata = {
  ...
  openGraph: {
    title: "El Asalto Federal a los Algoritmos: El Gran Preemption de Trump y el Futuro de la IA en Estados Unidos",
    description: "Análisis de la Propuesta de Marco Legislativo Nacional de Inteligencia Artificial de 2026: la pugna por la supremacía normativa entre la innovación centralizada y las salvaguardas de los estados.",
    url: "/normativa/national-ai-framework-estados-unidos",
    images: [
      {
        url: "/images/heroes/posts_images/normativa-ia-hero.jpg",
        width: 1200,
        height: 630,
        alt: "El Asalto Federal a los Algoritmos: El Gran Preemption de Trump y el Futuro de la IA en Estados Unidos",
      }
    ],
  },
  twitter: {
    ...
    title: "El Asalto Federal a los Algoritmos: El Gran Preemption de Trump y el Futuro de la IA en Estados Unidos",
    description: "Análisis de la Propuesta de Marco Legislativo Nacional de Inteligencia Artificial de 2026: la pugna por la supremacía normativa entre la innovación centralizada y las salvaguardas de los estados.",
    images: ["/images/heroes/posts_images/normativa-ia-hero.jpg"],
  },
};;
