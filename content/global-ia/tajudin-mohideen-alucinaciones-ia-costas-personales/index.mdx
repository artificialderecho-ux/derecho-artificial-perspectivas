...
export const metadata = {
  ...
  openGraph: {
    title: "Alucinaciones de IA en sede judicial: costas personales contra el abogado en Tajudin v Mohideen [2025] SGHCR 33",
    description: "Análisis de la primera resolución singapurense que impone costas personales por citar jurisprudencia ficticia generada por IA, con proyección al marco europeo.",
    url: "/global-ia/tajudin-mohideen-alucinaciones-ia-costas-personales",
    images: [
      {
        url: "/images/heroes/posts_images/default.jpg",
        width: 1200,
        height: 630,
        alt: "Alucinaciones de IA en sede judicial: costas personales contra el abogado en Tajudin v Mohideen [2025] SGHCR 33",
      }
    ],
  },
  twitter: {
    ...
    title: "Alucinaciones de IA en sede judicial: costas personales contra el abogado en Tajudin v Mohideen [2025] SGHCR 33",
    description: "Análisis de la primera resolución singapurense que impone costas personales por citar jurisprudencia ficticia generada por IA, con proyección al marco europeo.",
    images: ["/images/heroes/posts_images/default.jpg"],
  },
};;
