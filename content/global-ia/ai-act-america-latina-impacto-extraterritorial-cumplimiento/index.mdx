...
export const metadata = {
  ...
  openGraph: {
    title: "El AI Act ya gobierna América Latina: por qué el 7% de tu facturación global depende de Bruselas",
    description: "Análisis del impacto extraterritorial del Reglamento (UE) 2024/1689 en Latinoamérica: costes de cumplimiento, representante autorizado y el efecto Bruselas que ya moldea las leyes de Brasil y Chile.",
    url: "/global-ia/ai-act-america-latina-impacto-extraterritorial-cumplimiento",
    images: [
      {
        url: "/images/heroes/posts_images/default.jpg",
        width: 1200,
        height: 630,
        alt: "El AI Act ya gobierna América Latina: por qué el 7% de tu facturación global depende de Bruselas",
      }
    ],
  },
  twitter: {
